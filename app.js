...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('library.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('library.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('library.xml', function (err, result) {
            ...
            jsToXmlFile('library.xml', result, function(err){
